...
export type TimelineRailProps = {
  ...
  activeTrailClass?: string; // active trail color/class
  ...
  return (
    <section aria-label='timeline' className={cn('relative w-full', className)}>
      ...
      <ol
        ...
        role='list'
      >
        {/* Rail inside the relative ol container, centered vertically */}
        <div
          aria-hidden
          className={cn('absolute left-0 right-0 pointer-events-none', railClassName)}
          style={{
            top: '50%',
        ...
        >
          ...
          {emphasizeActiveTrail && lastActive >= 0 && (
            <div
              className={cn('absolute left-0 top-0 h-full rounded-full', activeTrailClass)}
              style={{
